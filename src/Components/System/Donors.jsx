...
function Donors() {
    ...
    const handleReadDonors = () => {
        axios.get(`https://backend-blood-bank-w3m1.onrender.com/read/donors?page=${page}`).then((res) => {
    ...
    const handleDeleteDonor = (id) => {
        axios.delete(`https://backend-blood-bank-w3m1.onrender.com/delete/donors/${id}`).then((res) => {
    ...
    const handleSearchDonor = (id) => {
        ...
        if(key){
            axios.get(`https://backend-blood-bank-w3m1.onrender.com/search/donors/${key}`).then((res) => {
                setDonorData(res.data)
            }).catch((error) => console.log(error))
        }
        else {
