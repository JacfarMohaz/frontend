...
function UpdateUsers() {
    ...
    const handleReadSingleUser = () => {
        axios.get(`https://backend-blood-bank-w3m1.onrender.com/readsingle/users/${params.id}`).then((res) => {
    ...
    const handleUpdateUser = (e) => {
        e.preventDefault()
        axios.put(`https://backend-blood-bank-w3m1.onrender.com/update/users/${params.id}`, {
            "userName": userName,
            "email": email,
            "role": role
        }).then((res) => {
