...
function UserAccept() {
    ...
    const handleApprovedUsers = () => {
        axios.get("https://backend-blood-bank-w3m1.onrender.com/approved/users").then((res) => {
    ...
    const handleUpdateApproved = (id) => {
        axios.put(`https://backend-blood-bank-w3m1.onrender.com/updateapproved/users/${id}`).then((res) => {
            toast(`User Accepted`, {
                position: "top-right",
                autoClose: 2000,
